;(function() {
	...
	console.log("responseCallback:"+responseCallback);
		if (responseCallback) {
			...
			var messageData = message.data ? (message.handlerName ? JSON.stringify(message.data) : message.data) : null;
		_WebViewJavascriptBridge._handleMessageFromJs(messageData,message.responseId||null,
